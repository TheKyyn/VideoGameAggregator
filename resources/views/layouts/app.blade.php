...
<body class="bg-gray-900 text-white">
    <header class="border-b border-gray-800">
        <nav class="container mx-auto flex flew-col lg:flew-row items-center justify-between px-4 py-6">
            <div class="flex flex-col lg:flew-row items-center">
                <a href="/">
                    <img src="" alt="main logo" class="w-32 flex-none">
                </a>
